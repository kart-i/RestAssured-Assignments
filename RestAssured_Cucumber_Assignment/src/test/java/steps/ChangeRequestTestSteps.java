...
//	}
	@Given("the base spec")
	public void the_base_spec() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@Given("the authentication process")
	public void the_authentication_process() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@When("a post request is sent with Created change request  and Created change request with Description")
	public void a_post_request_is_sent_with_created_change_request_and_created_change_request_with_description() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@Then("validate the status code is {int}")
	...
	@Then("validate the status line is {string} in the response")
	public void validate_the_status_line_is_in_the_response(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
